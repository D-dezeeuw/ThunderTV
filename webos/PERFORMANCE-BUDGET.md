...
| --- | ---: | ---: | ---: | ---: | --- |
| All eager JavaScript | 400 KiB | 104 KiB | 400 KiB | 107 KiB | Raw approximates TV parse work; gzip approximates web transfer. Includes the entry, every module preload, Spektrum, and its CSP registry. |
...
| Total shell text | 520 KiB | 128 KiB | 540 KiB | 132 KiB | Combined upper bound for HTML, eager JS, and initial CSS. |
