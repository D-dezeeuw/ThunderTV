...
| `player.ts`          | `player.active`, `player.zapHistory`, `player.visualizerPreset`                                                      | Yes — the §6.4 instant-restore pair; `visualizerPreset` also persists (the listener's Radio visualizer choice) |
